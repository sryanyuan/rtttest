...
public:
	...
	void LineFeedRender(float x, float y, const wchar_t* text, int nFeedNumber, bool _bStroke = true);
	void LineFeedRender(float x, float y, const char* text, int nFeedNumber, bool _bStroke = true);
